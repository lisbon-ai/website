...
The cropped, unfocused homepage uses `HOMEPAGE_ZOOM = 0.96`: four percent smaller
around the unchanged camera anchor, revealing slightly more of the edges without
moving the host box. Uncropped and focused views retain zoom 1. The matching
still and zoom are recorded in the manifest.
