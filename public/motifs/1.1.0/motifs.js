...
function Te(n, { assets: r = new URL(
	...
	return j.observe(n), n.dataset.renderer = "poster", n.dataset.frame = String(b), M(), V;
	function M() {
		cancelAnimationFrame(S), S = 0, x = null;
		let e = !!g && C && L();
		n.dataset.playing = String(e), u.hidden = O || E, u.textContent = C ? "Pause animation" : "Play animation", e ? S = requestAnimationFrame(P) : !g && !O && C && L() && N();
	}
